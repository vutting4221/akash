...
type EventCreateDep struct {
	Owner string `protobuf:"bytes,1,opt,name=owner,proto3" json:"owner" yaml:"owner"`
	DSeq  uint64 `protobuf:"varint,2,opt,name=dseq,proto3" json:"dseq" yaml:"dseq"`
}

func (m *EventCreateDep) Reset()         { *m = EventCreateDep{} }
...
func (m *EventCreateDep) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventCreateDep.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EventCreateDep) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventCreateDep.Merge(m, src)
}
func (m *EventCreateDep) XXX_Size() int {
	return m.Size()
}
func (m *EventCreateDep) XXX_DiscardUnknown() {
	xxx_messageInfo_EventCreateDep.DiscardUnknown(m)
}

var xxx_messageInfo_EventCreateDep proto.InternalMessageInfo

func (m *EventCreateDep) GetOwner() string {
	if m != nil {
		return m.Owner
	}
	return ""
...
func (m *EventCreateDep) GetDSeq() uint64 {
	if m != nil {
		return m.DSeq
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*EventCreateDep)(nil), "akash.deployment.v1beta1.EventCreateDep")
}
...
var fileDescriptor_bfe50ba12f1404bf = []byte{
	...
	,
}
...
func (m *EventCreateDep) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EventCreateDep) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventCreateDep) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventCreateDep) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventCreateDep) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EventCreateDep: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventCreateDep: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
