...
func TestInventoryZero(t *testing.T) {
	...
	s.podInterfaceMock.On("List", mock.Anything, podListOptions).Return(podList, nil)
...
func TestInventoryWithPodsError(t *testing.T) {
	...
	s.podInterfaceMock.On("List", mock.Anything, podListOptions).Return(nil, errForTest)
